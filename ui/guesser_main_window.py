...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_guess = QtWidgets.QLineEdit(parent=self.centralwidget)
        self.txt_guess.setObjectName("txt_guess")
        self.horizontalLayout_2.addWidget(self.txt_guess)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.txt_guess.setPlaceholderText(_translate("MainWindow", "STARE"))
        self.btn_letter_01.setText(_translate("MainWindow", "CheckBox"))
        self.btn_letter_02.setText(_translate("MainWindow", "CheckBox"))
        self.btn_letter_03.setText(_translate("MainWindow", "CheckBox"))
        self.btn_letter_04.setText(_translate("MainWindow", "CheckBox"))
        self.btn_letter_05.setText(_translate("MainWindow", "CheckBox"))
